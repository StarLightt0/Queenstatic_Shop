...
<head>
    ...
    <title>Edit Merek | QueenStatic Shop</title>
...
">
        ...
        <main class="flex-1 p-10">
            <div class="max-w-lg mx-auto bg-white p-8 rounded-2xl shadow-xl border border-gray-300 animate-fadeSlideUp">
                <h1 class="text-3xl font-bold mb-6 text-center">Edit Merek</h1>
                ...
                <form action="{{ route('merek.update', $merek->id_merek) }}" method="POST" class="space-y-4">
                    @csrf
                    @method('PUT')
                    <div>
                    ...
                    <div class="flex justify-between items-center mt-6">
                        <a href="{{ route('merek.index') }}" class="text-gray-500 hover:text-black transition">←
                            Kembali</a>

                        <button type="submit"
                            class="bg-black hover:bg-gray-800 text-white font-semibold px-6 py-2 rounded-lg transition">
                            Update
                        </button>
