...
<head>
    ...
    <title>Daftar Merek | QueenStatic Shop</title>
    <script src="https://cdn.tailwindcss.com"></script>
    <link rel="icon" type="image/png" href="{{ asset('images/Removebg.png') }}">
</head>

<body class="bg-gray-100 text-black min-h-screen"></body>
...
<div class="flex min-h-screen">
    ...
    <main class="flex-1 ml-64 p-10 overflow-y-auto animate-fadeSlideUp">
        <div class="max-w-4xl mx-auto bg-white p-8 rounded-2xl shadow-xl border border-gray-300 animate-fadeSlideUp">
            <h1 class="text-3xl font-bold mb-6 text-center">Daftar Merek</h1>
            ...
            <div class="flex justify-start mb-4">
                <a href="{{ route('merek.create') }}"
                    class="bg-black text-white px-4 py-2 rounded hover:bg-gray-800 transition">Tambah Merek</a>
            </div>
                ...
                <table class="w-full border border-gray-300 rounded-lg overflow-hidden">
                    <thead class="bg-gray-200 text-gray-700">
                        <tr>
                            ...
                            <th class="py-2 px-3">Nama Merek</th>
                    ...
                    <tbody>
                        @forelse ($mereks as $merek)
                            <tr class="border-t border-gray-300 hover:bg-gray-100">
                                ...
                                <td class="py-2 px-3">{{ $merek->nama_merek }}</td>
                                <td class="py-2 px-3 text-center">
                                    <a href="{{ route('merek.edit', $merek->id_merek) }}"
                                        class="text-gray-800 font-semibold hover:underline">Edit</a> |
                                    <form action="{{ route('merek.destroy', $merek->id_merek) }}" method="POST"
                                        class="inline">
                                        @csrf
                                        @method('DELETE')

                                        <button type="button"
                                            onclick="showDeletePopup('{{ route('merek.destroy', $merek->id_merek) }}', '{{ $merek->nama_merek }}')"
                        ...
                        @empty
                            <tr>
                                <td colspan="3" class="text-center py-4 text-gray-500">Belum ada merek.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
            ...
            <div class="flex justify-start mt-6">
                <a href="{{ route('barang.index') }}" class="text-gray-500 hover:text-black transition">← Kembali</a>
            </div>
