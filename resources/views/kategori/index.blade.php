...
<head>
    ...
    <title>Daftar Kategori | QueenStatic Shop</title>
    ...
    <div class="flex min-h-screen">
        ...
        <main class="flex-1 ml-64 p-10 overflow-y-auto animate-fadeSlideUp">
            <div class="max-w-4xl mx-auto bg-white p-8 rounded-2xl shadow-xl border border-gray-300 animate-fadeSlideUp">
                <h1 class="text-3xl font-bold mb-6 text-center">Daftar Kategori</h1>
                ...
                <div class="flex justify-start mb-4">
                    <a href="{{ route('kategori.create') }}"
                        class="bg-black text-white px-4 py-2 rounded hover:bg-gray-800 transition">Tambah Kategori</a>
                </div>
                        ...
                        <tbody>
                            @forelse ($kategoris as $kategori)
                                <tr class="border-t border-gray-300 hover:bg-gray-100">
                                    ...
                                    <td class="py-2 px-3">{{ $kategori->nama_kategori }}</td>
                                    <td class="py-2 px-3 text-center">
                                        ...
                                        <form action="{{ route('kategori.destroy', $kategori->id_kategori) }}" method="POST"
                                            ...
                                            <button type="button"
                                            onclick="showDeletePopup('{{ route('kategori.destroy', $kategori->id_kategori) }}', '{{ $kategori->nama_kategori }}')"
                ...
                <div class="flex justify-start mt-6">
                    <a href="{{ route('barang.index') }}" class="text-gray-500 hover:text-black transition">←
                        Kembali</a>
                </div>
            </div>
        </main>
