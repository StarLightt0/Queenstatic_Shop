...
<head>
    ...
    <title>Buat Transaksi | QueenStatic Shop</title>
...
<body class="bg-gray-100 text-black min-h-screen">
    ...
    <div class="flex min-h-screen">
        ...
        <main class="flex-1 ml-64 p-10 overflow-y-auto animate-fadeSlideUp">
            <h2 class="text-3xl font-bold text-center mb-8">Buat Transaksi Baru</h2>
                ...
                <div class="bg-white p-6 rounded-xl shadow border border-gray-300 mb-6">
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="id_transaksi" value="{{ 'TRX' . now()->format('YmdHis') }}"
                ...
                <div class="bg-white p-6 rounded-xl shadow border border-gray-300 mb-6">
                    <div class="flex justify-between items-center mb-4">
                        ...
                        <button type="button" onclick="tambahProduk()"
                            class="bg-black text-white px-4 py-2 rounded-lg hover:bg-gray-800 transition">+ Tambah
                            Produk</button>
                    </div>
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                        ...
                        <div class="bg-white p-6 rounded-xl shadow border border-gray-300">
                            ...
                            <input type="text" id="jumlah_bayar" name="jumlah_bayar"
                                value="{{ old('jumlah_bayar', number_format(0, ))  }}"
                                class="w-full border border-gray-400 rounded-lg px-3 py-2 mb-4"
                            ...
                            <div class="flex justify-between gap-4 mt-6">
                                <button type="submit"
                                    class="w-1/2 bg-black text-white py-2 rounded-lg hover:bg-gray-800 transition">Simpan</button>
                                <a href="{{ route('transaksi.index') }}"
                                    class="w-1/2 bg-white text-black border border-gray-400 py-2 rounded-lg hover:bg-gray-200 transition text-center">Batalkan</a>
                            </div>
                        </div>
                    </div>
            </form>
