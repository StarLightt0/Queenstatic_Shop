...
// export
    Route::get('/transaksi/export/{id}', [TransaksiController::class, 'export'])->name('transaksi.export');
    Route::get('/transaksi/export-bulan', [TransaksiController::class, 'exportBulan'])->name('transaksi.export.bulan');
